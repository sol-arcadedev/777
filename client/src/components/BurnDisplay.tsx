  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "2px 2px 0 rgba(0,0,0,0.4), inset 0 0 8px rgba(0,0,0,0.5), 0 0 8px rgba(153,69,255,0.15)",
        backdropFilter: "blur(4px)",
      }}
    >
      <div className="text-[8px] uppercase tracking-wider text-gold-dim mb-1">BURNED SUPPLY</div>
      <div className="text-xl font-bold text-gold">{formatted}</div>
